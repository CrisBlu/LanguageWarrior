...
public class RunWhisper : MonoBehaviour
{
    ...
    //A reference for the central audio processing script
    ...
    public void StartProcess(AudioClip inputAudio, MicrophoneManager callerReference)
    {
        outputString = "";
        ...
        LoadAudio(inputAudio);
        EncodeAudio();
        transcribe = true;
        StartCoroutine(Transcribe());
        microphoneManager = callerReference;
    }
    ...
    IEnumerator Transcribe()
    {
        ...
        //Set userInputText in AudioProcessing; this triggers the Conv LLM to start it's thing
        //microphoneManager.userInputText = outputString;
